  ...
  return (
    <div className="fixed top-[50%] left-[50%]  flex items-center justify-center z-2 w-full h-full bg-black/50 -translate-x-2/4 -translate-y-2/4 ">
      <div className=" w-[70%] bg-white rounded-t-lg overflow-auto ">
        <div className="w-[100%] h-10 pr-4 py-2.5 bg-mainBlue rounded-t-lg font-DanaDemiBold text-sm text-white text-right ">
          مشاهده پروفایل{" "}
        </div>
        <div className="px-[17px] ">
          <div className="flex items-center gap-x-1.5 pt-2.5 pr-1.5">
            ...
            >
              <path
                d="M10.5723 3.21484H2.85798C2.14791 3.21484 1.57227 3.79048 1.57227 4.50056V16.072C1.57227 16.7821 2.14791 17.3577 2.85798 17.3577H10.5723C11.2823 17.3577 11.858 16.7821 11.858 16.072V4.50056C11.858 3.79048 11.2823 3.21484 10.5723 3.21484Z"
                stroke="#4E6F88"
                strokeWidth="1.28571"
                strokeLinecap="round"
              ...
              />
              <path
                d="M4.78711 0.642578H13.1443C13.4852 0.642578 13.8123 0.778037 14.0534 1.01915C14.2945 1.26027 14.43 1.5873 14.43 1.92829V14.1426"
                stroke="#4E6F88"
                strokeWidth="1.28571"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <span className=" absolute mr-4 mt-1 px-1 text-sxs bg-white">
            مشخصات خیر{" "}
          </span>
          ...
          <span className=" absolute mr-4 mt-4 px-1 text-sxs bg-white">
            لیست واریزی ها{" "}
          </span>
   ...
   text-mainBlue p-2"
          ...
          <div className="flex justify-end mt-5 mb-2.5">
            <button
              className="font-DanaDemiBold text-xs rounded-lg bg-mainBlue text-white py-2.5 px-[14px]"
              onClick={onClose}
            >
              تایید{" "}
            </button>
