...
export default function NewFamilyModal({onClose}) {
...
<div className=' w-[90%] bg-white rounded-t-lg overflow-auto '>
      <div className='w-[100%] h-10 pr-4 py-2.5 bg-mainBlue rounded-t-lg font-DanaDemiBold text-sm text-white text-right '>ثبت خانواده جدید</div>
...
<span className='font-DanaDemiBold text-xs'>اطلاعات خانواده</span>
        </div>
        <span className=' absolute mr-4 mt-1 px-1 text-sxs bg-white'>مشخصات سرپرست</span>
        <div className=' mt-3 border border-tableBorder rounded-lg grid grid-cols-6 gap-3 p-3  child:h-8 child:border child:border-mainBlue/25 child:px-2.5 child:py-2 child:rounded-lg child:text-sxs child:font-DanaMedium'>
        ...
        <input type="text" placeholder='نسب ' />
        <input type="text" placeholder='وضعیت جسمانی ' />
        <input type="text" placeholder='جنسیت ' />
        <input type="text" placeholder='نام همسر ' />
        <input type="text" placeholder='علت تنهایی ' />
        <input type="text" placeholder='شماره حساب سرپرست ' />
        <input type="text" placeholder='شغل ' />
        <input type="text" placeholder='نام سرپرست' className=' col-span-3'  />
        </div>
        <span className=' absolute mr-4 mt-4 px-1 text-sxs bg-white'>اطلاعات خانواده </span>
        <div className=' mt-6 border border-tableBorder rounded-lg grid grid-cols-6 gap-3 p-3  child:h-8 child:border child:border-mainBlue/25 child:px-2.5 child:py-2 child:rounded-lg child:text-sxs child:font-DanaMedium'>
        <input type="text" placeholder='نوع بیمه ' />
        <input type="text" placeholder='وضعیت مسکن ' />
        <input type="text" placeholder='آدرس ' className=' col-span-3' />
        <input type="text" placeholder='تلفن ' />
        <input type="text" placeholder='منطقه  ' />
        <input type="text" placeholder='ارگان های حمایت کننده  '  />
        <input type="text" placeholder='زمینه های اشتغال ' className=' col-span-3'  />

        </div>
        <span className=' absolute mr-4 mt-4 px-1 text-sxs bg-white'>عضو جدید </span>
        <div className=' mt-6 border border-tableBorder rounded-lg grid grid-cols-6 gap-3 p-3  child:h-8 child:border child:border-mainBlue/25 child:px-2.5 child:py-2 child:rounded-lg child:text-sxs child:font-DanaMedium'>
        <input type="text" placeholder='نام و نام خانوادگی ' />
        <input type="text" placeholder='نام پدر '  />
        <input type="text" placeholder='جنسیت ' />
        ...
        <input type="text" placeholder='وضعیت جسمانی'  />
        <input type="text" placeholder='تاریخ تولد' />
        <input type="text" placeholder='وضعیت سرپرستی ' />
        <input type="text" placeholder='وضعیت تحصیلی  ' />
        </div>
        <span className=' absolute mr-4 mt-4 px-1 text-sxs bg-white'>لیست اعضا </span>
